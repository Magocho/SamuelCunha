...
void debug_TESTE(){
    ...
    printf(CINZA"\n   +----------------------- DEBUG -----------------------+\n");
    printf("\t"VERMELHO"[AVISO]\n");
    printf("\t> "CINZA"Nao ha controle das insercoes, entao se pode facilmente cria situacoes impossiveis\n");
    ...
    printf(CINZA"\t[DEBUG] Insira quantidade de Tarefa.:\n\t> "VERDE);
    while(scanf(" %d", &mMatriz->total_de_tarefa)!=1 || mMatriz->total_de_tarefa <= 0){
        printf(VERMELHO"\t> ERRO: quantidade de tarefas invalidos, tente outra vez!\n\t"BRANCO"> "VERDE);
        while(getchar() != '\n');
    }
    ...
    printf(CINZA"\t[DEBUG] Insira valores de tempo [t]\n\t> "ROXO);
    ...
    do{
        ...
        printf(CINZA"\t[DEBUG] Matriz recebida"BRANCO);
        imprime_matriz_TESTE(&mMatriz);

        printf(CINZA"\n\t[DEBUG] Insira valor da populacao inicial:\n\t> "AZUL);
        while(scanf(" %d", &i)!=1 || i <= 1){
            printf(VERMELHO"\t> ERRO: quantidade de individuos invalida, tente outra vez!\n\t"CINZA"> "AZUL);
            while(getchar() != '\n');
        }
        ...
        while(scanf(" %d", &qtd_MAQ)!=1 || (qtd_MAQ != 0 && qtd_MAQ != 1)){
            printf(VERMELHO"\t> ERRO: resposta invalida, tente outra vez!\n\t"CINZA"> "AMARELO);
            while(getchar() != '\n');
        }
...
//*********************************************************************************************************
        ...
        printf(CINZA"\t> Melhor: "AMARELO"%d\n"CINZA, tribo->darwin_boy->fitness);
